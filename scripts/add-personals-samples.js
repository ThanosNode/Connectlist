...
function generateTitle(subcategory) {
  const titles = {
    'M4W': [
...
function generateDescription(subcategory) {
  const descriptions = {
    'M4W': [
...
function createPersonalListing(userId, subcategory, state, city) {
