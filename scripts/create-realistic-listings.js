...
function generatePersonalDescription(subcategory, title) {
  const descriptions = {
    'web3 enthusiasts': [
...
function generateJobDescription(subcategory, title) {
  const descriptions = {
    'development': [
...
function generateBusinessDescription(subcategory, title) {
  const descriptions = {
    'consulting': [
...
function generatePrice(type, subcategory) {
  if (type === 'personal') {
...
function createListingObject(title, description, type, subcategory, state, city) {
